...
P0/P1 已有链路和新增一致性修复均已实测；发现缺陷继续修复。P2 八类已分别推进 Gateway、Edge、现场只读协议、ONVIF/GB28181 元数据、租约调度、影子与可信协议分发。Edge 远端命令、签名程序升级、自动登记、孪生关系与命名影子已补齐对应链路，详见下方模块实测。下一步推进跨架构协议制品及协议、调度、市场剩余边界；物理设备、生产和多主机现场验收仍未执行，不能写作全部 P2 完成。
