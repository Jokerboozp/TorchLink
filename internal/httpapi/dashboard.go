...
func (s *Server) dashboard(w http.ResponseWriter, r *http.Request) {
	...
	write(w, 200, map[string]any{"devices": devices, "online": states["ONLINE"], "activeAlarms": active, "highAlarms": high, "states": states, "levels": levels, "products": products, "trend": trend, "days": days, "offset": offset, "updatedAt": now.UnixMilli()})
}
