...
func main() {
	...
	options := edgeagent.Options{DiscoveryInterfaces: strings.Split(os.Getenv("IOT_EDGE_DISCOVERY_INTERFACES"), ","), DiscoveryProbeAddress: os.Getenv("IOT_EDGE_DISCOVERY_TARGET"), AllowAutoRegister: os.Getenv("IOT_EDGE_ALLOW_AUTO_REGISTER") == "true", AllowCommands: os.Getenv("IOT_EDGE_ALLOW_COMMANDS") == "true", AllowGoWorkers: os.Getenv("IOT_EDGE_ALLOW_GO_WORKERS") == "true", AllowedListenAddresses: strings.Split(os.Getenv("IOT_EDGE_LISTEN_ADDRESSES"), ","), CredentialFile: os.Getenv("IOT_EDGE_CREDENTIAL_FILE"), URL: os.Getenv("IOT_EDGE_PLATFORM_URL"), TenantID: os.Getenv("IOT_EDGE_TENANT_ID"), NodeID: os.Getenv("IOT_EDGE_NODE_ID"), Secret: os.Getenv("IOT_EDGE_SECRET"), DataDir: os.Getenv("IOT_EDGE_DATA_DIR"), AllowedSerialPorts: strings.Split(os.Getenv("IOT_EDGE_SERIAL_PORTS"), ","), AllowedCIDRs: strings.Split(os.Getenv("IOT_EDGE_ALLOWED_CIDRS"), ","), AllowInsecureHTTP: os.Getenv("IOT_EDGE_ALLOW_HTTP") == "true"}
