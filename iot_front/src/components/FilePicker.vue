...
.file-picker-button { position: relative; display: inline-flex; align-items: center; min-height: 32px; padding: 0 12px; flex: none; border: 1px solid #cbd5e1; border-radius: 4px; color: #334155; background: #fff; font-size: 13px; }
...
.file-picker-name { color: #64748b; font-size: 13px; overflow-wrap: anywhere; }
