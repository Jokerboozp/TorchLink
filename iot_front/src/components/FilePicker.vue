...
.file-picker-button { position: relative; display: inline-flex; align-items: center; min-height: 32px; padding: 0 12px; flex: none; border: 1px solid var(--border); border-radius: 4px; color: var(--text); background: var(--surface); font-size: 13px; }
...
.file-picker-name { color: var(--text); font-size: 13px; overflow-wrap: anywhere; }
