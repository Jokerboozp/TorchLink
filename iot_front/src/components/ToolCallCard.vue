...
.tool-meta { min-height:20px; margin-top:7px; padding-left:34px; display:flex; align-items:center; gap:10px; color:var(--muted-foreground); font-size:12px; }.tool-meta .el-button { margin-left:auto; padding:0; font-size:12px; } /* 定义当前元素的样式规则。 */
