...
<template>
  <section class="onboarding-workspace">
    ...
    <ui-card v-if="draft.step===0" class="surface-card" shadow="never">
      <h3>这次要接入哪种设备？</h3>
      <ui-radio-group class="onboarding-scenarios" :model-value="draft.scenario" @update:model-value="selectScenario"><ui-radio-button value="existing">已有型号</ui-radio-button><ui-radio-button value="new">首次接入新型号</ui-radio-button><ui-radio-button value="child">主设备下的子设备</ui-radio-button></ui-radio-group>
