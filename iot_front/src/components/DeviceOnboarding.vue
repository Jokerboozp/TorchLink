...
.onboarding-labels{padding:12px;border:1px solid #dce6f1;border-radius:8px;background:#fff}.onboarding-labels h4{margin:0 0 3px}.onboarding-labels>p{margin:0 0 10px;font-size:12px}.onboarding-label-row{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr) auto;gap:8px;align-items:end;margin:10px 0}.onboarding-label-row label{display:grid;min-width:0;gap:5px;color:#435a74;font-size:12px;font-weight:600}.onboarding-label-row :deep(.n-input){width:100%}.onboarding-label-empty{padding:10px;border:1px dashed #cbd8e7;border-radius:7px;background:#f9fbfe}
