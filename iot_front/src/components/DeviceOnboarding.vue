...
<style scoped>
.onboarding-workspace{max-width:1060px;margin:0 auto;color:var(--accent-foreground)}
.onboarding-workspace p{line-height:1.6;color:var(--accent-foreground)}
...
.onboarding-eyebrow{display:block;margin-bottom:7px;color:var(--accent-foreground);font-size:12px;font-weight:700;letter-spacing:.04em}
.onboarding-header h2{margin:0;color:var(--accent-foreground);font-size:22px;line-height:1.3}
...
.step-number{display:grid;place-items:center;flex:none;width:28px;height:28px;color:var(--accent-foreground);background:var(--surface-subtle);border-radius:50%;font-size:13px;font-weight:700}
...
.step-intro{padding-bottom:20px;margin-bottom:22px;border-bottom:1px solid var(--border)}.step-intro>span{color:var(--primary);font-size:12px;font-weight:700}.step-intro h3{margin:6px 0 5px;color:var(--accent-foreground);font-size:22px;line-height:1.3}.step-intro p{margin:0;font-size:13px}
.onboarding-section{margin:0 0 24px}.onboarding-section+.onboarding-section{padding-top:24px;border-top:1px solid var(--border)}.section-title{margin-bottom:16px}.section-title h4{margin:0 0 4px;color:var(--accent-foreground);font-size:16px}.section-title p{margin:0;font-size:13px}
.scenario-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.scenario-option{display:flex;flex-direction:column;align-items:flex-start;gap:7px;min-height:86px;padding:17px 18px;text-align:left;background:var(--card);border:1px solid var(--border);border-radius:9px;cursor:pointer}.scenario-option strong{color:var(--text-strong);font-size:15px}.scenario-option small{color:var(--muted-foreground);font-size:12px;line-height:1.5}.scenario-option:hover{border-color:var(--border-info);background:var(--surface-subtle)}.scenario-option.selected{background:var(--accent);border-color:var(--primary);box-shadow:inset 3px 0 var(--brand-flame)}.scenario-option.selected strong{color:var(--accent-foreground)}.scenario-option:focus-visible{outline:2px solid var(--primary);outline-offset:2px}
.selection-summary{display:flex;flex-wrap:wrap;align-items:center;gap:6px 18px;padding:14px 17px;background:var(--surface-subtle);border-left:3px solid var(--primary);border-radius:5px;color:var(--accent-foreground);font-size:13px}.selection-summary strong{flex-basis:100%;color:var(--accent-foreground);font-size:15px}.selection-summary small{flex-basis:100%;color:var(--accent-foreground)}.selection-summary-compact{margin-bottom:24px}
.onboarding-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0 18px}.onboarding-grid>div{min-width:0}
.onboarding-help{margin:7px 0 0;font-size:12px}.onboarding-inline-note{display:flex;align-items:center;flex-wrap:wrap;gap:8px;padding:12px 15px;background:var(--surface-subtle);border:1px solid var(--border);border-radius:7px;color:var(--accent-foreground);font-size:13px}.onboarding-inline-note :deep(.n-button){margin-left:auto}.onboarding-parent-line{margin:0 0 16px;color:var(--accent-foreground);font-size:13px}.onboarding-parent-line strong{color:var(--accent-foreground)}
.onboarding-helper-prompt{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:14px;margin-top:14px;padding:16px 18px;border:1px solid var(--border-info);border-left:3px solid var(--brand-flame);border-radius:8px;background:var(--surface-subtle)}
...
.onboarding-status{display:flex;justify-content:space-between;align-items:center;gap:18px;margin:0 0 26px;padding:17px 20px;background:var(--surface-subtle);border:1px solid var(--border-info);border-radius:9px}.onboarding-status>div{display:flex;align-items:center;flex-wrap:wrap;gap:10px}.onboarding-status small{color:var(--accent-foreground);font-size:12px;font-weight:700}.onboarding-status p{margin:0;color:var(--accent-foreground);font-size:13px}
.onboarding-check-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.onboarding-check-grid>div{min-width:0;padding:13px 15px;background:var(--card);border:1px solid var(--border);border-radius:7px}.onboarding-check-grid strong{display:block;color:var(--accent-foreground);font-size:12px;font-weight:600}.onboarding-check-grid p{margin:5px 0 0;color:var(--accent-foreground);font-size:14px;font-weight:600;overflow-wrap:anywhere}
...
.onboarding-check-grid .check-passed:last-child .check-icon{color:var(--brand-flame)}
...
.onboarding-check-details summary{width:max-content;cursor:pointer;color:var(--accent-foreground);font-weight:600}
.onboarding-helper{padding:8px 20px 28px}.onboarding-helper>p{color:var(--muted-foreground);font-size:13px;line-height:1.6}
.onboarding-actions :deep(.n-button--primary-type){border-bottom:2px solid var(--brand-flame)}
.onboarding-info{padding:19px 21px;margin-top:20px;border:1px solid var(--border);border-radius:9px;background:var(--card);overflow-wrap:anywhere}.onboarding-info h4{margin:0 0 14px;color:var(--accent-foreground);font-size:16px}.onboarding-info pre{overflow:auto;max-height:240px}.onboarding-info code{overflow-wrap:anywhere}.onboarding-info details{margin-top:14px}.connection-data-list{display:grid;gap:0}.connection-data-list>div{display:grid;grid-template-columns:138px minmax(0,1fr);gap:12px;align-items:start;padding:10px 0;border-bottom:1px solid var(--border)}.connection-data-list>div:last-child{border-bottom:0}.connection-data-list span{color:var(--accent-foreground);font-size:12px}.connection-data-list code{color:var(--accent-foreground);font-size:12px;line-height:1.6;word-break:break-all}.onboarding-credential{background:var(--surface-subtle);border-color:var(--border-warning)}.onboarding-credential :deep(.n-button){margin-top:12px}
.onboarding-actions{display:flex;justify-content:flex-end;align-items:center;flex-wrap:wrap;gap:10px;margin-top:28px;padding-top:20px;border-top:1px solid var(--border)}.onboarding-actions>span{flex:1;color:var(--primary);font-size:12px}.onboarding-actions-secondary{display:flex;flex-wrap:wrap;gap:8px;margin-right:auto}
