...
<style scoped>.permission-picker{width:100%;}.permission-group{padding:10px 0;border-bottom:1px solid var(--border)}.permission-actions{padding-left:24px;display:flex;flex-wrap:wrap;gap:4px 14px}.permission-actions .ui-checkbox{margin-right:0}</style>
