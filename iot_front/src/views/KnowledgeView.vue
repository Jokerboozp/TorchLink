...
.knowledge-stats { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:1px; overflow:hidden; border-radius:var(--radius-lg); background:var(--surface-muted); } /* 定义当前元素的样式规则。 */
...
.knowledge-panel { min-width:0; overflow:hidden; background:var(--surface); border-radius:var(--radius-lg); box-shadow:0 1px 2px color-mix(in srgb,var(--primary) 5%,transparent); } /* 定义当前元素的样式规则。 */
...
.knowledge-pagination { border-top:1px solid var(--border); } /* 定义当前元素的样式规则。 */
.knowledge-mobile-list { display:none; } /* 定义当前元素的样式规则。 */
.policy-panel { padding-bottom:8px; } /* 定义当前元素的样式规则。 */
.knowledge-policy-target { margin:0 24px; padding:16px 18px; display:grid; grid-template-columns:130px minmax(0,360px) 1fr; align-items:center; gap:14px; background:var(--surface-muted); border-radius:10px; } /* 定义当前元素的样式规则。 */
.knowledge-policy-target label { font-size:13px; font-weight:600; } /* 定义当前元素的样式规则。 */
.knowledge-policy-target small { color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
...
.knowledge-section-copy p { max-width:280px; margin:5px 0 0; color:var(--text-muted); font-size:12px; line-height:1.6; } /* 定义当前元素的样式规则。 */
...
.knowledge-policy-actions small { margin-right:auto; color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
...
.knowledge-detail-file small { color:var(--text-muted); font-size:12px; overflow-wrap:anywhere; } /* 定义当前元素的样式规则。 */
.knowledge-detail-meta { margin:0; padding:16px 18px; display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:16px; background:var(--surface-muted); border-radius:10px; } /* 定义当前元素的样式规则。 */
.knowledge-detail-meta div { min-width:0; } /* 定义当前元素的样式规则。 */
.knowledge-detail-meta dt { color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
...
.knowledge-detail-section-heading span { color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
.knowledge-rule-grid { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:8px; } /* 定义当前元素的样式规则。 */
.knowledge-rule-grid > div { min-width:0; padding:12px; display:grid; gap:5px; background:var(--surface-muted); border-radius:8px; } /* 定义当前元素的样式规则。 */
.knowledge-rule-grid small { color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
.knowledge-rule-grid strong { font-size:13px; overflow-wrap:anywhere; } /* 定义当前元素的样式规则。 */
.knowledge-index-rules p { margin:10px 0 0; color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
...
@media (max-width:640px) { /* 按屏幕条件调整样式。 */
  ...
  .knowledge-mobile-document { padding:14px; display:grid; gap:12px; background:var(--surface-muted); border-radius:10px; } /* 定义当前元素的样式规则。 */
  ...
  .knowledge-mobile-document-head small { color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
  ...
  .knowledge-mobile-document-foot small { color:var(--text-muted); font-size:12px; } /* 定义当前元素的样式规则。 */
