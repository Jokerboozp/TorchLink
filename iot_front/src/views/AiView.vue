...
.ai-runtime { flex:none; min-height:74px; margin-bottom:16px; padding:15px 18px; display:flex; align-items:center; justify-content:space-between; gap:20px; background:var(--card); border:1px solid var(--border); border-left:3px solid var(--primary); border-radius:4px; }.ai-runtime>div:first-child { display:grid; gap:3px; }.section-kicker { color:var(--primary); font-size:12px; font-weight:700; letter-spacing:.14em; }.ai-runtime strong { font-size:16px; }.ai-runtime small { color:var(--muted-foreground); }.runtime-actions { display:flex; align-items:center; gap:12px; }.runtime-status { display:flex; align-items:center; gap:8px; color:var(--accent-foreground); font-size:13px; white-space:nowrap; }.runtime-status i { width:7px; height:7px; background:var(--destructive); border-radius:50%; }.runtime-status i.online { background:var(--success); } /* 状态说明使用可读的前景色变量。 */
.ai-workbench { flex:1; min-height:0; overflow:hidden; display:grid; grid-template-rows:minmax(0,1fr); grid-template-columns:minmax(280px,320px) minmax(0,1fr); gap:16px; align-items:stretch; }.control-card,.ai-chat-card { height:100%; min-height:0; display:flex; flex-direction:column; }.control-card :deep(.el-card__header),.ai-chat-card :deep(.el-card__header) { flex:none; }.control-card :deep(.el-card__body),.ai-chat-card :deep(.el-card__body) { flex:1; min-height:0; overflow:hidden; }.card-header>div { display:grid; gap:3px; }.card-header small { display:block; }.control-card :deep(.el-card__body) { display:flex; padding:0; }.control-scroll { flex:1; min-width:0; min-height:0; padding:16px; overflow:auto; overscroll-behavior:contain; }.control-scroll>.el-alert { margin-bottom:14px; }.workflow-description { margin:-3px 0 14px; padding:12px; background:var(--surface-subtle); border:1px solid var(--border-info); border-radius:4px; }.workflow-description>div:first-child { display:flex; align-items:center; gap:9px; }.workflow-description>div:first-child>div { display:grid; gap:2px; }.workflow-description strong { color:var(--primary); font-size:13px; }.workflow-description small { color:var(--muted-foreground); font-size:12px; }.workflow-description p { margin:9px 0; color:var(--accent-foreground); font-size:12px; line-height:1.6; }.workflow-icon { width:30px; height:30px; display:grid; place-items:center; color:var(--card); background:var(--accent); border-radius:4px; font-size:12px; font-weight:800; }.capability-list { display:flex; flex-wrap:wrap; gap:5px; }.run-config { margin-bottom:2px; }.run-config>div { display:grid; grid-template-columns:minmax(0,1fr) 112px; gap:9px; }.run-config :deep(.el-input-number) { width:100%; }.provider-summary { margin:0 0 14px; padding:11px; display:grid; gap:7px; background:var(--card); border:1px solid var(--border); border-radius:4px; }.provider-summary>span { color:var(--muted-foreground); font-size:12px; }.provider-summary strong { font-size:13px; }.provider-summary small { color:var(--accent-foreground); }.sandbox-collapse { border-top:1px solid var(--border); }.collapse-title { width:100%; padding-right:8px; display:flex; align-items:center; justify-content:space-between; }.collapse-title>div { display:grid; gap:2px; }.collapse-title strong { font-size:13px; }.collapse-title small { color:var(--muted-foreground); font-size:12px; }.plugin-description { margin:-4px 0 15px; display:grid; gap:4px; }.plugin-description strong { color:var(--primary); font-size:12px; }.plugin-description span { color:var(--accent-foreground); font-size:12px; line-height:1.5; }.provider-select-row { display:grid; grid-template-columns:minmax(0,1fr) auto; gap:7px; }.provider-select-row :deep(.el-select) { width:100%; }.provider-profile-toolbar { margin:-5px 0 12px; display:flex; align-items:center; justify-content:space-between; gap:8px; }.provider-profile-toolbar small { color:var(--muted-foreground); font-size:12px; line-height:1.5; }.provider-profile-toolbar>div { display:flex; gap:5px; flex:none; }.provider-profile-editor { margin:0 0 13px; padding:11px; background:var(--surface-subtle); border:1px solid var(--primary); border-radius:5px; }.provider-profile-editor :deep(.el-form-item) { margin-bottom:10px; }.provider-profile-actions { display:flex; justify-content:flex-end; gap:7px; margin-top:10px; }.admin-notice { margin-bottom:14px; }.test-button { width:100%; margin-top:12px; }.test-result { margin-top:14px; padding:11px; border:1px solid; border-radius:4px; }.test-result.success { background:var(--surface-subtle); border-color:var(--border-success); }.test-result.failed { background:var(--surface-subtle); border-color:var(--border-danger); }.test-result>div { display:flex; justify-content:space-between; align-items:center; }.test-result p { margin:8px 0; color:var(--foreground); font-size:12px; line-height:1.6; white-space:pre-wrap; }.test-result small { color:var(--muted-foreground); word-break:break-all; } /* 定义当前元素的样式规则。 */
.knowledge-summary { margin:0 0 14px; padding:11px; display:grid; gap:5px; background:var(--surface-subtle); border:1px solid var(--border-success); border-radius:4px; }.knowledge-summary>div { display:flex; align-items:center; justify-content:space-between; }.knowledge-summary span,.knowledge-summary small { color:var(--success-foreground); font-size:12px; }.knowledge-summary strong { color:var(--success-foreground); font-size:12px; }.binding-numbers { display:grid; grid-template-columns:1fr 1fr; gap:9px; }.binding-numbers :deep(.el-input-number),.sandbox-collapse :deep(.el-select),.sandbox-collapse :deep(.el-radio-group) { width:100%; }.sandbox-collapse :deep(.el-radio-button) { flex:1; }.sandbox-collapse :deep(.el-radio-button__inner) { width:100%; padding-left:7px; padding-right:7px; } /* 定义当前元素的样式规则。 */
...
.agent-preview-summary { margin-top:14px; padding:12px; display:grid; gap:5px; background:var(--surface-subtle); border:1px solid var(--border-info); border-radius:5px; }.agent-preview-summary>div { display:flex; align-items:center; gap:7px; }.agent-preview-summary strong { color:var(--text-strong); font-size:13px; }.agent-preview-summary small { color:var(--accent-foreground); font-size:12px; }.agent-preview-summary p { margin:0; color:var(--accent-foreground); font-size:12px; line-height:1.6; }.agent-manifest-preview { max-height:min(58vh,560px); margin:12px 0 0; padding:14px; overflow:auto; color:var(--text-strong); background:var(--card); border:1px solid var(--border-info); border-radius:5px; font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace; font-size:12px; line-height:1.65; white-space:pre-wrap; word-break:break-word; } /* 定义当前元素的样式规则。 */
.workflow-admin-panel { margin-bottom:18px; padding:12px; background:var(--card); border:1px solid var(--border-info); border-radius:6px; }.workflow-admin-toolbar { display:flex; align-items:center; justify-content:space-between; gap:12px; margin-bottom:10px; }.workflow-admin-toolbar>div:first-child { min-width:0; display:grid; gap:3px; }.workflow-admin-toolbar strong { color:var(--text-strong); font-size:13px; }.workflow-admin-toolbar small { color:var(--muted-foreground); font-size:12px; }.workflow-admin-toolbar>div:last-child { display:flex; gap:6px; flex:none; }.workflow-admin-list { display:grid; gap:7px; }.workflow-admin-item { padding:10px; display:flex; align-items:flex-start; justify-content:space-between; gap:12px; background:var(--card); border:1px solid var(--border); border-radius:5px; }.workflow-admin-main { min-width:0; display:grid; gap:4px; }.workflow-admin-main>div { min-width:0; display:flex; align-items:center; flex-wrap:wrap; gap:5px; }.workflow-admin-main strong { max-width:260px; overflow:hidden; color:var(--foreground); font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.workflow-admin-main small { overflow:hidden; color:var(--muted-foreground); font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.workflow-admin-main p { margin:2px 0 0; overflow:hidden; color:var(--accent-foreground); font-size:12px; line-height:1.5; text-overflow:ellipsis; white-space:nowrap; }.workflow-admin-actions { display:flex; flex:none; align-items:center; gap:5px; }.workflow-admin-actions .el-button { margin-left:0; } /* 定义当前元素的样式规则。 */
.manifest-guide { margin:-2px 0 16px; overflow:hidden; background:var(--card); border:1px solid var(--border-info); border-radius:6px; }.manifest-guide-title { padding:12px 14px; display:flex; align-items:center; justify-content:space-between; gap:12px; background:var(--surface-subtle); border-bottom:1px solid var(--border-info); }.manifest-guide-title>div { display:grid; gap:3px; }.manifest-guide-title strong { color:var(--primary); font-size:13px; }.manifest-guide-title small { color:var(--accent-foreground); font-size:12px; }.manifest-field-list { display:grid; }.manifest-field { padding:10px 14px; display:grid; grid-template-columns:124px 74px minmax(0,1fr); align-items:start; gap:10px; border-bottom:1px solid var(--border); }.manifest-field:last-child { border-bottom:0; }.manifest-field code,.tool-whitelist code { color:var(--primary); font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace; font-size:12px; font-weight:700; word-break:break-all; }.manifest-field>span { width:max-content; padding:2px 6px; color:var(--muted-foreground); background:var(--surface-subtle); border-radius:3px; font-size:12px; }.manifest-field p { margin:0; color:var(--accent-foreground); font-size:12px; line-height:1.55; }.tool-whitelist { padding:13px 14px; display:grid; gap:10px; background:var(--card); border-top:1px solid var(--border-info); }.tool-whitelist>strong { color:var(--foreground); font-size:12px; }.tool-whitelist>div { display:grid; grid-template-columns:1fr 1fr; gap:7px; }.tool-whitelist span { min-width:0; padding:8px 9px; display:grid; gap:3px; background:var(--card); border-radius:4px; }.tool-whitelist small { color:var(--accent-foreground); font-size:12px; } /* 定义当前元素的样式规则。 */
.ai-chat-card :deep(.el-card__body) { display:flex; flex-direction:column; }.chat-header>div:last-child { display:flex; align-items:center; }.quick-prompts { flex:none; display:flex; flex-wrap:wrap; gap:7px; padding-bottom:12px; border-bottom:1px solid var(--border); }.quick-prompts button { padding:6px 9px; color:var(--primary); background:var(--surface-subtle); border:1px solid var(--border-info); border-radius:3px; font-size:12px; cursor:pointer; }.quick-prompts button:hover:not(:disabled) { color:var(--card); background:var(--accent); border-color:var(--primary); }.quick-prompts button:disabled { opacity:.5; cursor:not-allowed; }.chat-log { min-height:0; flex:1; padding:15px 3px 6px; overflow:auto; overscroll-behavior:contain; }.message-row { display:flex; align-items:flex-start; gap:9px; }.message-row.user { flex-direction:row-reverse; }.message-avatar { width:28px; height:28px; flex:0 0 28px; display:grid; place-items:center; color:var(--card); background:var(--accent-foreground); border-radius:4px; font-size:12px; font-weight:700; }.message-row.user .message-avatar { background:var(--accent); }.message-content { width:100%; min-width:0; max-width:min(82%,760px); margin-bottom:14px; }.message-row.user .message-content { width:fit-content; max-width:min(82%,760px); display:flex; flex-direction:column; align-items:flex-end; }.chat-message { width:100%; max-width:none; box-sizing:border-box; margin:0; padding:10px 12px; color:var(--foreground); background:var(--surface-subtle); border-radius:4px; font-size:13px; line-height:1.75; word-break:break-word; }.message-row.user .chat-message { width:fit-content; max-width:100%; }.chat-message.user { color:var(--card); background:var(--accent); }.chat-message.is-failed { background:var(--surface-subtle); border:1px solid var(--border-danger); }.chat-message.is-canceled { color:var(--accent-foreground); background:var(--card); border:1px dashed var(--input); }.chat-message p { margin:0; white-space:pre-wrap; }.typing { min-width:150px; display:flex; align-items:center; gap:5px; color:var(--muted-foreground); }.typing i { width:5px; height:5px; background:var(--muted-foreground); border-radius:50%; animation:pulse 1s infinite; }.typing i:nth-child(2){animation-delay:.16s}.typing i:nth-child(3){animation-delay:.32s}.typing span { margin-left:4px; font-size:12px; }.message-error { margin-top:9px; padding-top:9px; display:grid; gap:3px; border-top:1px solid var(--border-danger); }.message-error strong { color:var(--destructive); font-size:12px; }.message-error small { color:var(--muted-foreground); font-size:12px; word-break:break-all; }.message-error .el-button { width:max-content; height:auto; margin-top:3px; padding:0; }.message-meta { margin-top:5px; display:flex; align-items:center; gap:8px; color:var(--muted-foreground); font-size:12px; }.message-meta button { padding:0; color:var(--primary); background:none; border:0; font-size:12px; cursor:pointer; }.chat-compose { flex:none; display:flex; align-items:flex-end; gap:9px; padding-top:11px; border-top:1px solid var(--border); }.chat-compose .el-button { min-width:72px; }.chat-notice { margin-top:8px; color:var(--muted-foreground); text-align:center; } /* 定义当前元素的样式规则。 */
.rule-draft-card { margin-top:10px; padding:10px; display:grid; gap:7px; background:var(--surface-subtle); border:1px solid var(--warning); border-radius:4px; }.rule-draft-card>div { display:flex; align-items:center; justify-content:space-between; gap:8px; }.rule-draft-card small { color:var(--accent-foreground); }.rule-draft-card .el-button { width:max-content; } /* 定义当前元素的样式规则。 */
.ai-workbench { grid-template-columns:minmax(250px,286px) minmax(0,1fr); } /* 定义当前元素的样式规则。 */
.control-section-label { margin:2px 0 10px; display:flex; align-items:center; gap:7px; color:var(--foreground); font-size:12px; font-weight:700; letter-spacing:.02em; }.control-section-label span { width:22px; height:18px; display:grid; place-items:center; color:var(--primary); background:var(--surface-subtle); border-radius:3px; font-size:12px; } /* 定义当前元素的样式规则。 */
.runtime-overview { display:grid; grid-template-columns:1fr 1fr; gap:8px; }.overview-item { min-width:0; padding:10px; display:grid; gap:3px; color:inherit; text-align:left; background:var(--card); border:1px solid var(--border); border-radius:4px; cursor:pointer; transition:border-color .15s,background .15s; }.overview-item:hover { background:var(--surface-subtle); border-color:var(--primary); }.overview-item span { color:var(--muted-foreground); font-size:12px; }.overview-item strong { overflow:hidden; color:var(--foreground); font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.overview-item small { overflow:hidden; color:var(--accent-foreground); font-size:12px; text-overflow:ellipsis; white-space:nowrap; }.runtime-warning { margin-top:10px; }.manager-entry { width:100%; margin-top:12px; padding:11px 12px; display:flex; align-items:center; justify-content:space-between; color:inherit; text-align:left; background:var(--card); border:1px solid var(--input); border-radius:4px; cursor:pointer; }.manager-entry:hover { background:var(--surface-subtle); border-color:var(--primary); }.manager-entry>span { display:grid; gap:2px; }.manager-entry strong { font-size:12px; }.manager-entry small { color:var(--muted-foreground); font-size:12px; }.manager-entry b { color:var(--primary); font-size:12px; } /* 定义当前元素的样式规则。 */
.runtime-overview-single { grid-template-columns:1fr; }.overview-item-static { cursor:default; }.overview-item-static:hover { background:var(--card); border-color:var(--border); } /* 定义当前元素的样式规则。 */
.overview-item:first-child { background:var(--surface-subtle); border-color:var(--primary); }.overview-item:first-child:hover { border-color:var(--primary); }.overview-item:first-child strong { color:var(--primary); }.overview-item:last-child { background:var(--surface-subtle); border-color:var(--border-success); }.overview-item:last-child:hover { border-color:var(--success); }.overview-item:last-child strong { color:var(--success-foreground); } /* 定义当前元素的样式规则。 */
.overview-item-static { background:var(--card); border-color:var(--border); }.overview-item-static:hover { background:var(--card); border-color:var(--border); }.overview-item-static strong { color:var(--foreground); } /* 定义当前元素的样式规则。 */
.manager-panel { animation:manager-in .16s ease-out; }.manager-intro { margin-bottom:20px; padding:16px; background:var(--surface-subtle); border:1px solid var(--border-info); border-left:4px solid var(--primary); border-radius:6px; }.manager-intro>span { color:var(--primary); font-size:12px; font-weight:700; letter-spacing:.12em; }.manager-intro>div { margin-top:5px; display:flex; align-items:center; justify-content:space-between; gap:12px; }.manager-intro h3 { margin:0; color:var(--text-strong); font-size:16px; }.manager-intro p { margin:7px 0 0; color:var(--accent-foreground); font-size:12px; line-height:1.6; }.drawer-form :deep(.el-select),.drawer-form :deep(.el-radio-group) { width:100%; }.drawer-form :deep(.el-radio-button) { flex:1; }.drawer-form :deep(.el-radio-button__inner) { width:100%; }.workflow-manager :deep(.el-drawer__header) { margin-bottom:0; padding-bottom:16px; border-bottom:1px solid var(--border); }.workflow-manager :deep(.el-drawer__body) { padding-top:16px; }.agent-editor-dialog :deep(.el-dialog__body) { max-height:calc(100vh - 210px); overflow-y:auto; overscroll-behavior:contain; }.agent-editor-dialog .drawer-form { margin-top:14px; } /* 定义当前元素的样式规则。 */
...
.chat-message.is-canceled { color:var(--accent-foreground); } /* 定义当前元素的样式规则。 */
.knowledge-summary span, /* 定义当前元素的样式规则。 */
.knowledge-summary small { color:var(--success-foreground); } /* 定义当前元素的样式规则。 */
...
.message-meta button { min-height:24px; padding:3px 8px; color:var(--primary); background:var(--surface-subtle); border:1px solid var(--border-info); border-radius:.375rem; font-size:12px; cursor:pointer; } /* 定义当前元素的样式规则。 */
.message-meta button:hover { background:var(--accent); border-color:var(--primary); } /* 定义当前元素的样式规则。 */
...
.workflow-brief { margin:0 0 14px; padding:10px 12px; color:var(--accent-foreground); background:var(--surface-subtle); border-radius:.5rem; font-size:12px; line-height:1.6; }
