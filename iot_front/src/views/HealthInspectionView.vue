...
.inspection-progress { border-color:var(--info-border); background:var(--surface); } /* 定义当前元素的样式规则。 */
...
.inspection-progress-heading small,.inspection-progress-meta { color:var(--text); font-size:12px; line-height:1.5; } /* 定义当前元素的样式规则。 */
.inspection-progress-meta { display:flex; justify-content:space-between; gap:12px; margin-top:8px; } /* 定义当前元素的样式规则。 */
.inspection-findings { display:inline-block; margin-left:8px; color:var(--text); line-height:1.6; } /* 定义当前元素的样式规则。 */
