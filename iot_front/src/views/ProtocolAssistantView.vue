...
<template>
  <div class="protocol-generator" :aria-busy="!!busy">
    ...
    <el-form v-if="step==='input'" label-position="top" :disabled="!!busy" @submit.prevent="generate">
      ...
      <div class="generator-actions"><el-button v-permission="'POST /api/v1/ai/protocol-assistant/generate'" type="primary" :loading="busy==='generate'" native-type="submit">生成协议</el-button></div>
    </el-form>
    <template v-else>
