...
try {
  ...
  await click('设备接入')
  await until(()=>evaluate(`(()=>{const e=[...document.querySelectorAll('[role=tab]')].find(e=>e.textContent.trim()==='协议目录');if(!e)return false;e.click();return true})()`))
  ...
  await until(()=>evaluate(`document.querySelector('.el-tabs__content')?.textContent.includes('已安装')`))
