...
try {
  ...
  assert.equal(await evaluate(`window.__detailRequests.some(p=>p.includes('/shadow') || p.includes('/commands'))`),false,'closed advanced features must not issue requests')
