...
try {
  ...
  await until(()=>evaluate(`(()=>{const row=[...document.querySelectorAll('.el-table__row')].find(e=>e.textContent.includes('listen')&&e.getClientRects().length);const button=[...(row?.querySelectorAll('button')||[])].find(e=>e.textContent.trim()==='编辑');if(!button)return false;button.click();return true})()`))
