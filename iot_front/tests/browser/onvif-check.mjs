...
try {
  ...
  await fill('摄像头地址','127.0.0.1')
  await fill('端口',process.env.IOT_TEST_ONVIF_PORT)
  ...
  console.log('PASS: ONVIF browser node selection, rejected local credential reference, authenticated TLS/Digest read, metadata fill, narrow dialog and explicit save')
} finally {
