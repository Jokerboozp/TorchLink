...
try {
  ...
  const openMarket=async()=>until(()=>evaluate(`(()=>{const e=[...document.querySelectorAll('[role=menuitem]')].find(e=>e.textContent.trim()==='组织发布');if(!e)return false;e.click();return true})()`))
  await openMarket()
