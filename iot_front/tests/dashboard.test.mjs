...
import { deviceSegments, ringSegments, productBars, trendGeometry } from '../src/dashboard.js' /* 引入当前代码需要的依赖。 */
...
function setup(api) { /* 定义 setup 函数。 */
  ...
  const context=vm.createContext({ref,computed,api,deviceSegments,ringSegments,productBars,alarmLevels:{},AbortController,setTimeout,clearTimeout,notifyError(){},defineEmits:()=>()=>{},onMounted(){},onBeforeUnmount(fn){cleanup=fn},window:{removeEventListener(){}}}) /* 声明 context。 */
